      ...
      {isAgencyPage ? (
        <footer className="agencyFooter h-card">
          ...
          <nav aria-label="GrowthCast links">
            ...
            <a className="u-email" href="mailto:ewhite@growthcast.app">Email Our Founder</a>
            <a href="https://linkedin.com/in/edwardjwhiteiii" target="_blank" rel="noreferrer">Connect With Our Founder</a>
            <a href="https://www.linkedin.com/company/146310031/" target="_blank" rel="noreferrer">Follow GrowthCast</a>
          </nav>
