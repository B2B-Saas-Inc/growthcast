...
Many teams face the same problem: functional plans look reasonable on their own but do not reconcile across the complete customer path. Name the people involved and the point where their work stops. Skip broad goals that nobody can inspect or own.
