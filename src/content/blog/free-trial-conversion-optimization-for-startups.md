...
Many teams face the same problem: the team treats the final upgrade rate as one problem even though several earlier customer decisions shape it. Name the people involved and the point where their work stops. Skip broad goals that nobody can inspect or own.
